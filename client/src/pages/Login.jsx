...
const Login = () => {
  ...
  {/* state to switch between signup and login */}
  const[state, setState] = useState('Sign Up')

  {/* creating state variables to store input fields data */}
  ...
  return (
    ...
    <img onClick={()=>navigate('/')}  src= {assets.logo} alt="" className='absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer'/>
      ...
      {/*if signup page is there then only display name feild for login page we need only username and pass field*/}
          {state === 'Sign Up' && (
